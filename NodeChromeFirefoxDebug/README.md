# Selenium Grid Node - ChromeFirefox Debug
...
[`selenium/node-chromefirefox-debug` Dockerfile](https://github.com/SeleniumHQ/docker-selenium/blob/master/NodeChromeFirefoxDebug/Dockerfile)
...
```
$ docker run -d -P --link selenium-hub:hub selenium/node-chromefirefox-debug
```
...
``` dockerfile
FROM selenium/node-chromefirefox-debug:2.48.2
